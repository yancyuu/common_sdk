...
class DifyClient(BaseAPI, APIClientProtocol):
    ...
    def __init__(self, api_key):
        super().__init__(api_key, get_env("DIFY_BASE_URL"))
        
    async def chat_completions(self, query, user, conversation_id=None, inputs=None, files=[], auto_generate_name=True) -> Any:
        """
    ...
    async def completion_messages_with_streaming(self, user: str, conversation_id: str = None, inputs: Dict[str, Any] = None, files: List[Dict[str, Any]] = None) -> Any:
        """
        completion_messages 文本生成型应用的消息发送接口
